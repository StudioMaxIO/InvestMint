...
contract Token is ERC20Interface {
    ...
    constructor (string memory name, string memory symbol, uint initialSupply, uint8 decimals, address founder) public {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
        _founder = founder;
...
contract TokenFactory {
    ...
    function createToken(string memory name, string memory symbol, uint initialSupply, uint8 decimals) public returns(address){
        ...
        address newToken = address(new Token(name, symbol, initialSupply, decimals, msg.sender));
